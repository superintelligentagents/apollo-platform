...
| Author appeal | Apollo V2 in the author's browser, after a first rejection | Anonymous rejection reason and reviewer rubric notes | A new task revision carrying the first rejection reason and the author's appeal reason, plus a `v2-review/appeals/` routing marker | V2 `#/my-tasks` |

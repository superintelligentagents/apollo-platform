...
a task or any private record. The `2026-09-10.8` performance pass makes large-history
...
and reduces Dashboard counting from six mailbox scans to one. Chunk yields use the

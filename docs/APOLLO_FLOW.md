...
- Only human task reviewers approve or reject task definitions, and only human trajectory graders establish the final rubric and overall task-satisfaction verdicts.
